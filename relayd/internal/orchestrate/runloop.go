...
// forwarding toward FORWARDED, then check every FORWARDED leg for
// upstream settlement. Each phase is independent and each leg within a
// phase is isolated from its neighbors' failures -- the same
