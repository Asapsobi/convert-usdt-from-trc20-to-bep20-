...
alarm), run for real across many seeds spanning two days, all `ALL PASSED`.
Not yet built: real per-vendor `EXPIRED` semantics (gated on a real vendor, R2/R4).
